...
# ------------------------ Run LDpred2
temfile = paste0('/dcs04/nilanjan/data/ydun/PRS_Bridge/ref_1kg/chr',chr,'/chr_', chr,'_merged.bk')
if (!file.exists(temfile)){
  snp_readBed(paste0('/dcs04/nilanjan/data/ydun/PRS_Bridge/ref_1kg/chr',chr,'/chr_', chr,'_merged.bed'))
}
obj.bigSNP <- snp_attach(paste0('/dcs04/nilanjan/data/ydun/PRS_Bridge/ref_1kg/chr',chr,'/chr_', chr,'_merged.rds'))
...
## compute correlation
POS2 <- snp_asGeneticPos(CHR, POS, dir = paste0('/dcs04/nilanjan/data/ydun/ldpred2/tmp_dir/EUR/'), ncores = 4)
## indices in info_snp
...
corr <- bigsparser::as_SFBM(corr0, compact = TRUE)
