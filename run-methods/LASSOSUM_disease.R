...
test.bfile <- paste0('/dcs04/nilanjan/data/ydun/PRS_Bridge/validation/validation_', trait, '/chr', chr)
LDblocks <- "EUR.hg19"
...
prscode = paste(paste0('/dcs04/nilanjan/data/ydun/tools/plink2'),
                ...
                paste0(' 1 3 cols=+scoresums,-scoreavgs --score-col-nums 4-83 --bfile /dcs04/nilanjan/data/ydun/PRS_Bridge/validation/validation_', trait, '/chr', chr),
                paste0(' --out ', '/dcs04/nilanjan/data/ydun/SinglePRS/', trait, '/LASSOSUM/chr', chr, "/ref_N", ref_N, "validation"))
system(prscode)

prscode = paste(paste0('/dcs04/nilanjan/data/ydun/tools/plink2'),
                paste0('--score ', '/dcs04/nilanjan/data/ydun/SinglePRS/', trait, '/LASSOSUM/chr', chr, '/LASSOSUMeffect-hm3-EUR-ref_N', ref_N, '.txt'),
                paste0(' 1 3 cols=+scoresums,-scoreavgs --score-col-nums 4-83 --bfile /dcs04/nilanjan/data/ydun/PRS_Bridge/validation/tuning_', trait, '/chr', chr),
